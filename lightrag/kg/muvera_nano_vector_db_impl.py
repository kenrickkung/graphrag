...
from lightrag.kg.fde_generator import (
...
@final
@dataclass
class MuveraNanoVectorDBStorage(BaseVectorStorage):
    ...
    async def upsert(self, data: dict[str, dict[str, Any]]) -> None:
        ...
        embeddings = np.concatenate(
            [generate_document_fde_batch(batch_embs, self.muvera_config) for batch_embs in embeddings_list]
        )
    ...
    async def query(
        ...
        embedding = generate_query_fde(embedding[0], self.muvera_config)
